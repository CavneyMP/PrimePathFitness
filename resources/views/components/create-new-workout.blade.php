            ...
            <div class="bg-gray-900 shadow sm:rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    <div class="sm:flex sm:items-start sm:justify-between">
                        <div>
                            <h3 class="text-base font-semibold leading-6 text-white">Create a New Workout plan</h3>
                            <div class="mt-2 max-w-xl text-sm text-gray-300">
                                <p>You can now generate custom workout plans using filters and equipment preferences!.</p>
                            </div>
                        </div>
                        <div class="mt-5 sm:ml-6 sm:mt-0 sm:flex sm:flex-shrink-0 sm:items-center pt-4">
                        <a href="{{ route('workout-create.index') }}" class="inline-flex items-center">
                            <button type="button"
