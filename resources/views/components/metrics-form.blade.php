...
<div class="mx-auto max-w-3xl">
    ...
    <div class="grid grid-cols-1 gap-y-6">
      <div>
        ...
        <input type="number" name="age" id="age" autocomplete="age" class="mt-1 block w-full rounded-md bg-gray-700 border-transparent focus:border-gray-600 focus:bg-gray-600 focus:ring-0 text-white">
      </div>

      <div>
        <label for="weight" class="block text-sm font-medium text-gray-300">Weight (kg)</label>
        <input type="number" step="0.1" name="weight" id="weight" autocomplete="weight" class="mt-1 block w-full rounded-md bg-gray-700 border-transparent focus:border-gray-600 focus:bg-gray-600 focus:ring-0 text-white">
      </div>

      <div>
        <label for="height" class="block text-sm font-medium text-gray-300">Height (cm)</label>
        <input type="number" step="0.1" name="height" id="height" autocomplete="height" class="mt-1 block w-full rounded-md bg-gray-700 border-transparent focus:border-gray-600 focus:bg-gray-600 focus:ring-0 text-white">
      </div>
    ...
    <div class="flex justify-end gap-x-6">
      ...
      <button type="submit" class="text-sm font-semibold text-white bg-indigo-600 py-2 px-4 rounded-md hover:bg-indigo-500">
        Save
      </button>
    </div>
  </form>
